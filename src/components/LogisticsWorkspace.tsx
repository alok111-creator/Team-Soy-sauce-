    ...
    <div className="bg-white border-4 border-[#FFB800] rounded-3xl overflow-hidden shadow-xl z-10 w-full font-sans text-neutral-800">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#525560] font-medium">
              Smart direct match with no commission / Bina commission Seedha Sauda!
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto justify-between md:justify-end">
          ...
          <div className="flex items-center gap-1 bg-[#F4F2E9] p-1.5 rounded-2xl border border-neutral-200 select-none">
            ...
            >
              ...
              <span>Gaddi/Truck Owner (Transporter)</span>
            </button>
            <button
              onClick={() => {
                setCurrentRole("shipper");
            ...
            >
              ...
              <span>Samaan Bhejna Hai (Shipper)</span>
            </button>
          </div>
      ...
      <div className="px-5 py-4 bg-[#FCFAF0] border-b-2 border-[#EBEBE0] flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <span className="text-[10px] font-bold tracking-wider text-[#E15307] uppercase">
            {currentRole === "transporter" ? "TRUCK OWNERS MARKET" : "FARMERS & WHOLESALERS INBOX"}
          </span>
          <h2 className="text-lg font-extrabold text-neutral-900 tracking-tight flex items-center gap-2">
            <span>{currentRole === "transporter" ? "🚛 Transporter (Gaddi Wala) Dashboard" : "🌾 Samaan/Cargo Shipper Dashboard"}</span>
          </h2>
        </div>
        ...
        <div className="flex flex-wrap gap-2 text-xs">
          {currentRole === "transporter" && (
            <>
              ...
              >
                📥 Samaan Dhundhein (Available Loads)
              </button>
              <button
              ...
              >
                🚛 Apni Gaddi Post Karein (List Trucks)
              </button>
              <button
          ...
          {currentRole === "shipper" && (
            <>
              ...
              >
                📋 Mera Samaan Requirement (Posted Cargo)
              </button>
              <button
              ...
              >
                ➕ Samaan Post Karein (Post New Cargo)
              </button>
              <button
      ...
      <div className="p-6 bg-[#FCFAF0]">
          ...
          <div className="space-y-5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-4 rounded-2xl border-2 border-[#FFF0BF]">
              <div className="relative flex-1">
                ...
                <input
                  type="text"
                  placeholder="Kahan ke liye gaddi chahiye? Road search e.g. Delhi, Mumbai, Bengaluru..."
              ...
              <div className="flex items-center gap-1.5 text-xs text-neutral-600 font-bold bg-[#E6F3FF] border border-[#BFDBFE] px-3 py-1.5 rounded-lg">
                ...
                <span>Smart Match on! Hum automatic matched gaddi milayenge!</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    >
                      <div className="absolute top-4 right-4 flex items-center gap-1.5">
                        <span className="text-[10px] uppercase tracking-wider font-extrabold bg-[#E0F2FE] text-[#0369A1] px-2.5 py-1 rounded-full border border-[#BAE6FD]">
                          {shipment.status === "Posted" ? "Naya Load" : "Bids Pending"}
                        </span>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2 p-3.5 bg-[#F9FBFF] rounded-2xl border border-[#D5E6FF] text-xs font-semibold">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-neutral-500 w-24">Uthana Hai (From):</span>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-neutral-500 w-24">Pahunchana Hai (To):</span>
                        ...
                        <div className="grid grid-cols-2 gap-2 text-xs font-semibold">
                          <div className="bg-[#FAF9F5] p-2.5 rounded-xl border border-neutral-150">
                            <span className="text-neutral-400 block text-[9px] uppercase">Approx Weight (Vajan)</span>
                            <span className="text-neutral-850 font-extrabold text-sm">{shipment.weight} Metric Tons</span>
                          </div>
                          <div className="bg-[#FAF9F5] p-2.5 rounded-xl border border-neutral-150">
                            <span className="text-neutral-400 block text-[9px] uppercase">Target Date (Tarik)</span>
                            <span className="text-neutral-850 font-extrabold text-sm">{shipment.date}</span>
                          </div>
                        </div>

                        <div className="space-y-1">
                          <span className="text-[9px] font-bold text-neutral-400 uppercase tracking-widest block">Instructions (Jaruri Baat)</span>
                      ...
                      <div className="border-t border-neutral-100 pt-3.5 flex items-center justify-between">
                        <span className="text-xs text-neutral-500 font-semibold">
                          Party Name: <strong className="text-neutral-800">{shipment.shipperName}</strong>
                        </span>
                        ...
                        {isAlreadyOffered ? (
                          <span className="text-emerald-700 text-xs font-bold flex items-center gap-1 bg-emerald-50 px-3.5 py-2 rounded-xl border border-emerald-200">
                            <CheckCircle2 className="w-4 h-4 text-[#10B981]" /> Bidh Lagayi Hai
                          </span>
                        ) : (
                          <button
                          ...
                          >
                            <span>Offer Lagayein / Apply</span>
              ...
              {shipments.filter(s => s.status === "Posted" || s.status === "Offer Submitted" || s.status === "Awaiting Approval").length === 0 && (
                <div className="col-span-2 text-center py-12 text-neutral-500 bg-white border-2 border-dashed border-neutral-200 rounded-3xl font-medium">
                  Abhi koi saman posted nahi hai. Shipper tab par jaakar Load post karke dekhein!
                </div>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-5 bg-white border-2 border-[#FFD034] p-6 rounded-3xl space-y-4 shadow-sm">
              <div className="space-y-1">
                <h4 className="font-extrabold text-[#111] text-base flex items-center gap-1.5">
                  ...
                  Apni Gaddi Ka Route & Capacity Dalein
                </h4>
                <p className="text-xs text-neutral-500 font-medium">
                  Aapki gaddi kab khaali hai aur kahan jaa sakti hai?
                </p>
              </div>
              ...
              <form onSubmit={handlePostCapacity} className="space-y-4 text-xs font-semibold">
                <div className="grid grid-cols-2 gap-3.5">
                  <div>
                    <label className="block text-neutral-500 mb-1">Apna Naam (Owner Name)</label>
                    <input
                      type="text"
                ...
                <div>
                  <label className="block text-neutral-500 mb-1">Gaddi Abhi Kahan Hai? (Current Hub Location)</label>
                  <select
                  ...
                  >
                    <option value="New Delhi (Hub North)">New Delhi (Hub North) [Uttar Bharat]</option>
                    <option value="Mumbai (Hub West)">Mumbai (Hub West) [Pashchim Bharat]</option>
                    <option value="Bengaluru (Hub South)">Bengaluru (Hub South) [Dakshin Bharat]</option>
                    <option value="Kolkata (Hub East)">Kolkata (Hub East) [Purv Bharat]</option>
                  </select>
                </div>

                <div>
                  <label className="block text-neutral-500 mb-1">Kahan Tak Jaa Sakte Hain? (Destination Route)</label>
                  <select
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-xs font-bold"
                ...
                <div className="grid grid-cols-2 gap-3.5">
                  <div>
                    <label className="block text-neutral-500 mb-1">Weight Limit (Vajan - Tons)</label>
                    <input
                      type="number"
                      min="1"
                      className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
                  ...
                  <div>
                    <label className="block text-neutral-500 mb-1">Khaali Hone ki Tarik (Date)</label>
                    <input
                      type="date"
                      className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
                ...
                <div>
                  <label className="block text-neutral-500 mb-1">Pasandeeda Samay (Preferred Time slot)</label>
                  <input
                    type="text"
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
                    placeholder="e.g. Subah 8 se dophar 2 baje"
            ...
            <div className="lg:col-span-7 space-y-4">
              <div className="flex items-center justify-between">
                <h4 className="text-xs text-neutral-500 block uppercase font-bold tracking-wider">Humari active gaddiyan status</h4>
                ...
                {capacities.map((cap) => (
                  <div key={cap.id} className="bg-white border-2 border-neutral-200 p-4 rounded-2xl flex items-center justify-between gap-4 shadow-sm">
                    <div className="space-y-1 font-sans">
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-bold text-[#2563EB] bg-[#EFF6FF] border border-[#BFDBFE] px-2 py-0.5 rounded">Gaddi #{cap.id}</span>
        ...
        {currentRole === "transporter" && activeTab === "active_jobs" && (
          <div className="space-y-5">
            <h4 className="text-xs text-neutral-500 uppercase font-black tracking-wider">
              Verification dashboard for: {offerForm.transporterName}
            </h4>
            ...
            <div className="grid grid-cols-1 gap-5">
                    ...
                    <div key={shipment.id} className="bg-white border-2 border-neutral-200 p-5 rounded-3xl shadow-sm flex flex-col md:flex-row justify-between gap-5">
                      <div className="space-y-4 flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          <span className="text-xs font-bold bg-[#FAF9F5] text-neutral-500 border border-neutral-200 px-3 py-1 rounded-full">Cargo No: {shipment.id}</span>
                          <span className={`text-[11px] font-bold px-3 py-1 rounded-full uppercase flex items-center gap-1 ${
                            ...
                            Status: {shipment.status === "Posted" ? "Offer Applied" : shipment.status}
                          </span>
                        </div>
                        ...
                        <div className="bg-[#FFFDF5] p-4 rounded-2xl border border-[#FFD034] space-y-2 text-xs font-semibold text-neutral-700">
                          <span className="text-[#E15307] text-[10px] block uppercase font-extrabold tracking-wider">Aapki Boli aur Sartein (Your Bid Conditions)</span>
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                            <div>
                              <span className="text-neutral-400 block text-[9px]">Pickup Time:</span>
                              <span className="text-neutral-900 font-bold">{offer.pickupTime}</span>
                            </div>
                            <div>
                              <span className="text-neutral-400 block text-[9px]">ETA Commitment:</span>
                              <span className="text-neutral-900 font-bold">{offer.deliveryCommitment}</span>
                            </div>
                            <div>
                              <span className="text-neutral-400 block text-[9px]">Offer Price / Toll Fee:</span>
                              <span className="text-[#E15307] font-extrabold text-xs">₹{offer.extraCharges} Charges</span>
                            </div>
                            <div>
                              <span className="text-neutral-400 block text-[9px]">Truck Allocated:</span>
                        ...
                        {offer.status === "Counter-Offer" && (
                          <div className="bg-[#FFFDF4] border-2 border-amber-400 p-4 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-3 font-sans">
                            <div>
                              <span className="text-amber-800 font-extrabold text-[#963F01] text-xs">⚠️ Counter-Offer Received / भाड़े का प्रस्ताव आया है</span>
                              <p className="text-xs text-neutral-850 mt-1 font-bold">
                                Shipper has proposed a Counter Price of: <span className="text-emerald-700 font-black text-sm">₹{offer.counterPrice}</span> instead of your ₹{offer.extraCharges} charges.
                              </p>
                            </div>
                            <button
                              onClick={() => {
                                onUpdateOfferStatus(shipment.id, offer.id, "Approved");
                                alert(`🎉 Mubarak Ho! You accepted the counter-offer of ₹${offer.counterPrice}! Deal is locked & cargo scheduled.`);
                              }}
                            ...
                            >
                              Accept Proposed Price & Lock Deal (डील पक्की करें) ✅
                            </button>
                          </div>
                        )}
                        ...
                        <div className="bg-[#EFF6FF] border-2 border-[#BFDBFE] p-4 rounded-2xl flex items-center justify-between flex-wrap gap-3">
                          <div>
                            <span className="text-neutral-500 block text-[10px] font-bold uppercase tracking-wide">📞 Shipper/Farmer Ka Asli Phone Number (Contact Details)</span>
                            {isApproved ? (
                              <div className="flex flex-wrap items-center gap-3 mt-1.5">
                                ...
                                <span className="bg-emerald-500 text-white text-[10px] px-2 py-0.5 font-bold rounded-full">APPROVED & CONNECTED ✅</span>
                              </div>
                            ) : (
                              <div className="text-xs text-neutral-600 flex items-center gap-1.5 mt-1 font-bold">
                                <span className="text-amber-600 animate-pulse">🔒 PHONE NUMBER HIDDEN (Surakshit).</span>
                                <span>Shipper ke approval ke baad number khulega.</span>
                              </div>
                            )}
                          </div>
                      ...
                      <div className="flex flex-col justify-between items-end border-t md:border-t-0 md:border-l border-neutral-200 pt-4 md:pt-0 md:pl-5 shrink-0 min-w-[200px] text-xs">
                        <div className="text-right w-full md:w-auto">
                          <span className="text-neutral-400 block font-bold text-[9px] uppercase">Boli Status</span>
                          <span className={`font-extrabold text-xs block mt-1 ${
                            ...
                            • {offer.status === "Approved" ? "Mila Sauda (Approved!)" : offer.status === "Rejected" ? "Rejected (Nahi Mila)" : "Shipper check kar rahe hain"}
                          </span>
                        </div>
                        ...
                        {isApproved && (
                          <div className="w-full space-y-2 mt-4">
                            {shipment.status === "Approved" && (
                              ...
                              >
                                Gaddi Nikal Gayi 🛫 (Start Transit)
                              </button>
                            )}
                            ...
                            {shipment.status === "In Transit" && (
                              ...
                              >
                                Samaan Pahunch Gya ✅ (Mark Delivered)
                              </button>
                            )}
              ...
              {shipments.filter(s => s.offers.some(o => o.transporterName === offerForm.transporterName)).length === 0 && (
                <div className="text-center py-10 bg-white border border-neutral-250 rounded-2xl text-neutral-500 font-semibold text-xs">
                  Aapne abhi tak kisi saman par boli nahi lagayi hai. "Loads Dekhein" tab par jaakar apply karein!
                </div>
              )}
            </div>
          ...
          <div className="max-w-2xl mx-auto bg-white border-2 border-[#E15307] p-6 rounded-3xl space-y-4 shadow-sm text-neutral-800">
            <div className="space-y-1">
              <h4 className="font-extrabold text-base text-[#111] flex items-center gap-1.5 uppercase tracking-tight">
                ...
                Naya Samaan Bhejne Ke Liye Gaddi Bulaayein (Post Load)
              </h4>
              <p className="text-xs text-neutral-500 font-medium">
                Apna route aur samaan ka vajan dalein. Gaddi wale seedhe aapse contact karenge.
              </p>
            </div>
            ...
            <form onSubmit={handlePostShipment} className="space-y-4 text-xs font-semibold">
              <div className="grid grid-cols-2 gap-3.5">
                <div>
                  <label className="block text-neutral-500 mb-1">Apna Naam / Wholesaler Business Name</label>
                  <input
                    type="text"
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
                ...
                <div>
                  <label className="block text-neutral-500 mb-1">Mobile number (Secure / Surakshit)</label>
                  <input
                    type="text"
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
              ...
              <div className="grid grid-cols-2 gap-3.5">
                <div>
                  <label className="block text-neutral-500 mb-1">Kahan se Load uthana hai? (Pickup Location)</label>
                  <select
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-xs font-bold"
                    value={shipmentForm.pickup}
                    onChange={(e) => setShipmentForm({...shipmentForm, pickup: e.target.value})}
                  >
                    <option value="New Delhi (Hub North)">New Delhi (Hub North) [Uttari Bharat]</option>
                    <option value="Mumbai (Hub West)">Mumbai (Hub West) [Pashchimi Bharat]</option>
                    <option value="Bengaluru (Hub South)">Bengaluru (Hub South) [Dakshini Bharat]</option>
                    <option value="Kolkata (Hub East)">Kolkata (Hub East) [Purvi Port Hub]</option>
                  </select>
                </div>
                <div>
                  <label className="block text-neutral-500 mb-1">Kahan pahunchana hai? (Delivery Destination)</label>
                  <select
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-xs font-bold"
              ...
              <div className="grid grid-cols-3 gap-3.5">
                <div className="col-span-2">
                  <label className="block text-neutral-500 mb-1">Samaan ka naam (Goods items details)</label>
                  <input
                    type="text"
                    placeholder="e.g. Potato sacks, pharmaceuticals, raw cotton bales, electronics..."
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
                ...
                <div>
                  <label className="block text-neutral-500 mb-1">Vajan (Weight in Tons)</label>
                  <input
                    type="number"
                    step="0.1"
                    min="0.1"
              ...
              <div className="grid grid-cols-2 gap-3.5">
                <div>
                  <label className="block text-neutral-500 mb-1">Bhejne ki Tarik (Date)</label>
                  <input
                    type="date"
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
                ...
                <div>
                  <label className="block text-neutral-500 mb-1">Pasandgida samay slots (Pre-time slot)</label>
                  <input
                    type="time"
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
              ...
              <div>
                <label className="block text-neutral-500 mb-1 font-bold text-black">Aapke Dwara Tay Kiya Gaya Bhada (Shipper Decided Fare/Price in ₹) *</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-neutral-500 mb-1">Gaddi wale ke liye koi sandesh (Special Instructions)</label>
                <textarea
                  rows={2}
                  className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900 font-medium"
                  placeholder="e.g. Double trip tarpaulin require, driver must have driving license card..."
        ...
        {currentRole === "shipper" && activeTab === "my_shipments" && (
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b-2 border-neutral-200 pb-3">
              <h4 className="text-xs text-neutral-500 uppercase font-black tracking-wider">Aapke post kiye gaye cargo requirements</h4>
              <button
                onClick={() => setActiveTab("post_shipment")}
              ...
              >
                <PlusCircle className="w-4 h-4 mr-0" /> Aur Naya Samaan Post Karein
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4">
                  ...
                  <div key={s.id} className="bg-white border-2 border-neutral-200 p-5 rounded-3xl shadow-sm">
                    <div className="flex flex-col md:flex-row justify-between gap-4">
                      ...
                      <div className="space-y-2 flex-1 font-sans text-xs">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <span className={`px-2.5 py-1 rounded-full font-extrabold text-[9px] uppercase ${
                            ...
                            📍 Status: {s.status === "Posted" ? "Gaddi dhundh rahe hain" : s.status}
                          </span>
                        </div>

                        <div>
                          <h5 className="font-extrabold text-base text-neutral-900">{s.goodsType}</h5>
                          <p className="text-xs text-neutral-500 font-bold">🚛 Approximate Weight: {s.weight} Tons</p>
                          <p className="text-xs text-blue-700 font-bold">📍 Route: {s.pickup} → {s.destination}</p>
                          <p className="text-[10px] text-neutral-400">Scheduled: {s.date} (Slot: {s.time})</p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col justify-between items-end shrink-0 min-w-[200px] border-t md:border-t-0 md:border-l border-neutral-200 pt-3 md:pt-0 md:pl-5 font-sans">
                        <div className="text-right w-full md:w-auto">
                          <span className="text-[9px] text-[#E15307] font-extrabold block uppercase tracking-wider">Aaye Hue Bids (Gaddi Owners)</span>
                          <span className="text-base font-black text-neutral-850">{s.offers.length} Direct Bids received</span>
                        </div>
                        ...
                        {hasOffers ? (
                          ...
                          >
                            Review & Accept offers ({s.offers.length}) ➔
                          </button>
                        ) : (
                          <span className="text-[10px] text-neutral-400 font-bold italic mt-4">
                            Gaddi wale abhi conditions post kar rahe hain...
                          </span>
                        )}
                      </div>
              ...
              {shipments.length === 0 && (
                <div className="text-center py-12 bg-white border border-neutral-200 rounded-2xl text-neutral-400 font-bold italic">
                  Aapne abhi tak koi samaan bhejne ke liye request post nahi kiya h. "Samaan Post Karein" par click karein!
                </div>
              )}
            </div>
          </div>
        ...
        {currentRole === "shipper" && activeTab === "active_track" && (
          <div className="space-y-4">
            <h4 className="text-xs text-neutral-500 uppercase font-black tracking-wider">
              Approved Gaddi Deals / Phone Contacts & Chat Room
            </h4>
            ...
            <div className="grid grid-cols-1 gap-4">
                    ...
                    <div key={shipment.id} className="bg-white p-5 border-2 border-neutral-200 rounded-3xl space-y-4 shadow-sm text-xs font-semibold text-neutral-700">
                      ...
                      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2 border-b border-neutral-100 pb-3">
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-[11px] text-[#2563EB] font-extrabold">🤝 Secured with: {approvedOffer.transporterName}</span>
                          </div>
                          <p className="text-neutral-500 mt-1">Truck Model: {approvedOffer.truckDetails}</p>
                        </div>
                        <span className="px-3 py-1 bg-emerald-50 border border-emerald-200 text-emerald-700 font-extrabold rounded-full uppercase text-[9px]">
                          🤝 GADDI SEEDHE SECURED (Sauda Pakka)
                        </span>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div className="bg-[#FAF9F5] p-3 rounded-2xl border">
                          <span className="text-neutral-400 block text-[9px] uppercase">Gaddi Wale Ka Phone Contact</span>
                        ...
                        <div className="bg-[#FAF9F5] p-3 rounded-2xl border">
                          <span className="text-neutral-400 block text-[9px] uppercase">Agreed Charges/Toll</span>
                          <span className="text-[#E15307] font-black text-sm mt-0.5 block">₹{approvedOffer.extraCharges} CHARGES</span>
                        </div>
                        <div className="bg-[#FAF9F5] p-3 rounded-2xl border">
                          <span className="text-neutral-400 block text-[9px] uppercase">Current Transit Status</span>
                          <span className="text-blue-700 font-black text-xs block mt-0.5">{shipment.status} • (Gaddi Driver update)</span>
                        </div>
                      </div>
                      ...
                      <div className="border-t-2 border-neutral-100 pt-4">
                        ...
                        <div className="bg-neutral-50 border rounded-2xl p-4 h-56 flex flex-col justify-between">
                              ...
                              return (
                                <div key={msg.id} className={`flex flex-col ${isMe ? 'items-end' : 'items-start'}`}>
                                  ...
                                  <span className="text-[8px] text-neutral-400 tracking-wider font-extrabold mt-1">
                                    {msg.timestamp} • {msg.sender === "Shipper" ? "Me (Mera Message)" : "Gaddi Driver Name"}
                                  </span>
                                </div>
                              );
                            })}
                          ...
                          <div className="flex gap-2 border-t pt-3 mt-3">
                            <input
                              type="text"
                              placeholder="Type transaction update or status sync..."
              ...
              {shipments.filter(s => s.status === "Approved" || s.status === "In Transit" || s.status === "Delivered").length === 0 && (
                <div className="text-center py-10 bg-white border border-neutral-250 rounded-2xl text-neutral-400 font-bold italic">
                  Abhi koi active sauda/chat chalu nahi hai. Pehle kisi transporter ki lgi bolit par Accept button dabaayein!
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-white border-4 border-[#2563EB] rounded-3xl max-w-lg w-full p-6 text-neutral-800 space-y-4 max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="flex justify-between items-center border-b pb-3">
              <h3 className="font-extrabold text-[#111] text-base flex items-center gap-1.5 uppercase tracking-wide">
                ...
                Samaan Par Boli Lagayein (Apply Conditions Bids)
              </h3>
            ...
            <div className="bg-[#FFFDF3] border-2 border-[#FFD034] p-4 rounded-2xl text-xs font-semibold leading-relaxed">
              <p className="text-neutral-500 text-[10px] uppercase font-bold tracking-wider">Cargo Requirement Details</p>
              <p className="text-neutral-900 font-extrabold text-sm">{viewingShipment.goodsType} ({viewingShipment.weight} Tons)</p>
              <p className="text-blue-800">Route Kahan se Kahan: {viewingShipment.pickup} ➜ {viewingShipment.destination}</p>
              <p className="text-neutral-600 font-normal mt-1.5">Instructions: "{viewingShipment.specialInstructions}"</p>
            </div>

            <form onSubmit={(e) => handleSubmitOffer(e, viewingShipment.id)} className="space-y-3.5 text-xs font-bold">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-neutral-500 mb-1">Apna Transport Company / Driver Naam</label>
                  <input
                    type="text"
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
                ...
                <div>
                  <label className="block text-neutral-500 mb-1">Asli Phone Mobile Number</label>
                  <input
                    type="text"
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
              ...
              <div>
                <label className="block text-neutral-500 mb-1">Gaddi / Truck Name and specs (TATA/Leyland model)</label>
                <input
                  type="text"
                  className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="col-span-2">
                  <label className="block text-neutral-500 mb-1">Kab Gaddi Utha Sakti H? (Pickup hours)</label>
                  <input
                    type="text"
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
                ...
                <div>
                  <label className="block text-neutral-500 mb-1">Charges (₹)</label>
                  <input
                    type="number"
                    className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
              ...
              <div>
                <label className="block text-neutral-500 mb-1">Arriving/Delivery Commitment details (ETA hours)</label>
                <input
                  type="text"
                  className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
              ...
              <div>
                <label className="block text-neutral-500 mb-1">Koi special baat extra note (e.g. tarpaulin sheet loaded)</label>
                <textarea
                  rows={2}
                  className="bg-neutral-50 border-2 border-neutral-200 rounded-xl px-3 py-2 w-full text-neutral-900"
              ...
              <div className="flex gap-2 justify-end border-t pt-3 mt-4">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-[#2563EB] hover:bg-blue-700 text-white font-extrabold rounded-xl"
                >
                  Confirm Boli lagayein (Launch Bid)
                </button>
              </div>
            </form>
          </div>
          ...
          <div className="bg-white border-4 border-[#E15307] rounded-3xl max-w-xl w-full p-6 text-neutral-800 space-y-4 max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="flex justify-between items-center border-b pb-3">
              <h3 className="font-extrabold text-base text-neutral-900 flex items-center gap-1.5 uppercase">
                ...
                Review Transporter Bids ({viewingOffersForShipment.offers.length})
              </h3>
            ...
            <div className="bg-[#FAF9F5] p-3 rounded-2xl border text-xs font-semibold">
              <p className="text-neutral-400 block text-[9px] uppercase">My Cargo Loading details</p>
                ...
                return (
                  <div key={offer.id} className="bg-white border-2 border-[#FFD034] p-4 rounded-2xl text-xs space-y-3 font-semibold relative text-neutral-800">
                    <div className="flex justify-between items-center flex-wrap gap-2">
                      <div>
                        <span className="text-neutral-400 text-[9px] block">Gaddi Owner / Transporter Name</span>
                        <span className="text-neutral-900 text-sm font-black">{offer.transporterName}</span>
                      </div>
                      <div className="text-right">
                        <span className="text-neutral-400 text-[9px] block">Asli Phone number</span>
                        <span className="bg-neutral-100 text-neutral-600 px-2 py-0.5 border rounded-lg font-bold">🔒 Secure phone</span>
                      </div>
                    </div>

                    <div className="bg-[#FAF9F5] p-3 rounded-xl border grid grid-cols-2 gap-2 text-[11px]">
                      <div>
                        <span className="text-neutral-400 block text-[9px]">Truck Model:</span>
                      ...
                      <div>
                        <span className="text-neutral-400 block text-[9px]">Charges (₹):</span>
                        <span className="text-[#E15307] font-black">₹{offer.extraCharges} Charges</span>
                      </div>
                    </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => {
                            ...
                            alert(`Counter tariff offer of ₹${counterAmt} sent directly to the transporter!`);
                          }}
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={() => {
                            ...
                            setViewingOffersForShipment(null);
                            alert("Bidh rejected successfully.");
                          }}
                        ...
                        <button
                          onClick={() => {
                            ...
                            setViewingOffersForShipment(null);
                            alert(`🎉 Mubarak Ho! Sauda pakka hua! Samaan status sets to Approved. Phone details verified and unmasked.`);
                          }}
