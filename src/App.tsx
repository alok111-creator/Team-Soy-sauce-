      ...
      {activeView === "landing" ? (
        <div className="relative min-h-screen flex flex-col justify-between p-6 sm:p-12 z-10">
          ...
          <div className="max-w-4xl mx-auto w-full text-center py-12 flex-1 flex flex-col justify-center items-center">
            ...
            <div className="inline-flex items-center gap-1.5 bg-white/5 border border-white/10 rounded-full px-3.5 py-1.5 mb-6 text-[11px] font-mono text-blue-400">
              <Shield className="w-3.5 h-3.5" />
              <span>SPACEX / PALANTIR GRADE LOGISTICS OS</span>
            </div>

            {/* Glowing Main Landing Titles */}
            <h1 className="text-4xl sm:text-6xl font-black text-neutral-100 tracking-tight font-sans leading-tight mb-6">
              Predict Logistics Problems <br />
            ...
            <p className="text-sm sm:text-base text-neutral-400 max-w-2xl mx-auto leading-relaxed mb-10 font-sans">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full max-w-md">
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-semibold text-sm rounded-xl transition-all shadow-xl shadow-blue-600/20 border border-blue-500/30 flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 bg-white/5 hover:bg-white/10 text-neutral-300 hover:text-white font-semibold text-sm rounded-xl transition-all border border-white/10 flex items-center justify-center gap-2 cursor-pointer"
              >
                <span>Watch Automated Simulation</span>
              </button>
            </div>

            {/* Indian-style Insta Portal choices */}
            <div className="mt-12 w-full max-w-3xl z-20">
              <h2 className="text-sm font-black text-white uppercase tracking-widest mb-4 font-mono text-center">
                ━ Transporter (वाहन चालक) & Cargo Shipper (सामान भेजने वाला) Portal Direct Entry ━
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <div className="mt-4">
                    <h4 className="font-sans font-black text-[#E15307] text-[12px] uppercase tracking-wide">Control Center (नियंत्रण केंद्र)</h4>
                    <p className="text-[11px] text-neutral-800 leading-snug font-bold mt-1">
                      Monitor live grid, risk meters, and simulate severe weather/closure events. (लाइव ग्रिड और मुख्य परिचालन का नियंत्रण करें।)
                    </p>
                  </div>
                </button>
                ...
                >
                  <span className="text-2xl">🚛</span>
                  <div className="mt-4">
                    <h4 className="font-sans font-black text-blue-700 text-[12px] uppercase tracking-wide font-mono">Transporter (वाहन चालक)</h4>
                    <p className="text-[11px] text-neutral-800 leading-snug font-bold mt-1">
                      Post truck load space, browse shipping requests, submit direct condition bids. (ट्रक क्षमता पोस्ट करें और सीधे सौदे की बोली लगाएं।)
                    </p>
                  </div>
                </button>
                ...
                >
                  <span className="text-2xl">📦</span>
                  <div className="mt-4">
                    <h4 className="font-sans font-black text-[#963F01] text-[12px] uppercase tracking-wide">Cargo Shipper (सामान भेजने वाला)</h4>
                    <p className="text-[11px] text-neutral-800 leading-snug font-bold mt-1">
                      Publish cargo load details, receive offers, make counter-bids, direct sauda. (माल विवरण पोस्ट करें और वाहन चालकों के साथ मोल-भाव करें।)
                    </p>
                  </div>
                </button>
              </div>
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center p-6 sm:p-12 z-20 font-sans">
          <div className="w-full max-w-md bg-[#FFFDE8] border-4 border-amber-400 rounded-3xl p-6 shadow-2xl space-y-6 relative overflow-hidden">
            ...
            <div className="text-center">
              ...
              <h2 className="text-2xl font-black tracking-tight text-black">APNA LOGIX GATEWAY</h2>
              <p className="text-xs text-neutral-800 font-bold font-mono uppercase mt-0.5">Secure Logistics Entry • सुरक्षित प्रवेश द्वार</p>
            </div>
            ...
            {authMode === "login" ? (
              <form
                onSubmit={(e) => {
                  ...
                  alert("Successfully logged in! (लॉग-इन सफल हुआ!)");
                }}
                className="space-y-4"
              >
                <div>
                  <label className="block text-xs font-black text-black uppercase mb-1.5">Mobile Phone Number (मोबाइल नंबर) *</label>
                  <input
                    type="tel"
                ...
                <div>
                  <label className="block text-xs font-black text-black uppercase mb-1.5">Secure Password (पासवर्ड) *</label>
                  <input
                    type="password"
                    placeholder="••••••••"
                    className="w-full bg-white border-2 border-neutral-300 rounded-xl px-3.5 py-2.5 text-xs text-black font-semibold focus:outline-none focus:border-[#2563EB]"
                ...
                >
                  Verify & Proceed Securely (सुरक्षित प्रवेश करें)
                </button>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      ...
                      onClick={() => {
                        ...
                        setCurrentUser({
                          name: "Vahan Chalak (वाहन चालक / Transporter)",
                          phone: "+91 98110 55432",
                          role: "transporter"
                        });
                        setDashboardRoleChoice("workspace");
                        setCurrentWorkspaceRole("transporter");
                        alert("Logged in as Transporter Guest! (वाहन चालक के रूप में लॉग-इन सफल)");
                      }}
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        setLoginPassword("password123");
                        setCurrentUser({
                          name: "Cargo Shipper (सामान भेजने वाला / Shipper)",
                          phone: "+91 70012 34567",
                          role: "shipper"
                        });
                        setDashboardRoleChoice("workspace");
                        setCurrentWorkspaceRole("shipper");
                        alert("Logged in as Cargo Shipper Guest! (सामान भेजने वाले के रूप में लॉग-इन सफल)");
                      }}
              ...
              <form
                onSubmit={(e) => {
                  ...
                  alert(`Registration complete! Account created for ${signupForm.name}. (पंजीकरण पूर्ण हुआ!)`);
                }}
                className="space-y-4 text-left font-sans"
              >
                <div>
                  <label className="block text-xs font-black text-black uppercase mb-1">What is Your Name? (आपका नाम क्या है?) *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-black text-black uppercase mb-1">Select Your Role (मंच पर अपनी भूमिका चुनें) *</label>
                  <select
                    className="w-full bg-white border-2 border-neutral-300 rounded-xl px-3.5 py-2 text-xs text-black font-semibold focus:outline-none focus:border-[#2563EB]"
                    ...
                    required
                  >
                    <option value="transporter">Transporter / Vehicle Operator (वाहन चालक / गाड़ी मालिक)</option>
                    <option value="shipper">Cargo Shipper / Merchant (सामान भेजने वाला / व्यापारी)</option>
                    <option value="operator">Grid Operator / Control Agent (नियंत्रण केंद्र ऑपरेटर)</option>
                  </select>
                </div>

                <div>
                  <label className="block text-xs font-black text-black uppercase mb-1">Mobile Phone Number (मोबाइल नंबर) *</label>
                  <input
                    type="tel"
                ...
                <div>
                  <label className="block text-xs font-black text-black uppercase mb-1">Create Secure Password (पासवर्ड बनाएं) *</label>
                  <input
                    type="password"
                ...
                <div>
                  <label className="block text-xs font-black text-black uppercase mb-1">Business City / Head Office (शहर/जिला)</label>
                  <input
                    type="text"
                    placeholder="New Delhi, India"
                    className="w-full bg-white border-2 border-neutral-355 rounded-xl px-3.5 py-2 text-xs text-black font-semibold focus:outline-none focus:border-[#2563EB]"
                ...
                >
                  Register & Enter Terminal (पंजीकरण करें और प्रवेश करें)
                </button>
              </form>
            )}
          ...
          <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-[#EBEBE0] pb-4 px-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-right hidden sm:block">
                ...
                <div className="text-[10px] text-blue-700 font-extrabold font-mono">PORT: CENTRAL</div>
              </div>
            </div>
